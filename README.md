...
- **Автоматическая проверка** — ESLint, TypeScript, 37 тестов и Webpack-сборка запускаются в CI.
...
Отдельной кнопки демо-режима в интерфейсе нет.
...
Текущее покрытие сценариев: **12 test suites · 37 тестов**.
